**Manager, Software Engineering - GCP Hosted Control Planes**
**Job Description**
...
* Hire, develop, and retain a team of senior software engineers building and operating the GCP HCP managed service
* Define and refine team processes for an agent-augmented engineering workflow: how work is decomposed and specified for agents, how agent output is reviewed and validated, how quality is measured when code production is partially automated, and how throughput and engineering effectiveness are tracked
* Coach engineers on harness engineering practices — crafting specifications that agents can execute well, designing constraints that prevent architectural drift, building documentation that serves as reliable agent context, and developing the critical judgment needed to evaluate machine-generated work
* Manage project delivery including estimation, scheduling, risks, dependencies, and coordination with Product Management, technical support, and peer engineering teams
* Lead your team through ongoing changes in tooling, process, and methodology as agent capabilities and harness engineering practices evolve rapidly
* Develop career paths and growth frameworks for engineers whose role is shifting from direct code production toward system design, constraint engineering, specification writing, and agent orchestration
* Ensure that the team's harness infrastructure (linters, structural tests, CI gates, documentation systems) is maintained and improved as a first-class engineering investment, not treated as overhead
* Coordinate with peer managers and technical leads across OpenShift engineering, GCP platform teams, and service delivery organizations
* Participate in sprint planning, release cycles, and operational readiness reviews
* Support customer-facing conversations including pre-sales technical discussions and escalation resolution
* Participate in on-call escalation rotations alongside your team
* Foster a culture of automation, continuous improvement, and blameless incident response
...
* Experience managing teams that build or operate managed/hosted cloud services under SLA
* Experience with Kubernetes or OpenShift in a production environment
* Hands-on experience with AI coding tools (Copilot, Claude, Codex, or similar) sufficient to understand the capabilities and limitations your team is working with
* Experience defining engineering processes or quality frameworks for teams adopting new development methodologies
